...
import Alert from "@mui/material/Alert";
 ...
 setIdCliente(row.original.id_fuenteCliente)
 setNombre(row.original.nombre_fuente);
 ...
 if(row.original.estado ===0){
   ...
   handleEditar(row.original.id_fuenteCliente,row.original.nombre_fuente,row.original.descripcion,1);
 }else{
  
   handleEditar(row.original.id_fuenteCliente,row.original.nombre_fuente,row.original.descripcion,0);
 }
  ...
  <Box>
        ...
        <div style={{ position: "relative", marginTop: 5, marginRight: 5 }}>
          {alerta ? (
            ...
            >
              {editar?"¡Industria se Edito exitosamente!":"¡Industria se Creo exitosamente!"}
            </Alert>
          ) : (
            ""
          )}
   ...
   <MaterialReactTable
        ...
        renderRowActionMenuItems={({ closeMenu, row }) => [
          <MenuItem > <EditIcon sx={{ mr:1 }} /> <b>Eliminar Fuente</b> </MenuItem>,
          ...
          } > <EditIcon sx={{ mr:1 }} /> <b>Editar Fuente</b> </MenuItem>
 ...
 {editar?"Editar Fuente":"Crear Fuente"}
          </Typography>
        </Box>
