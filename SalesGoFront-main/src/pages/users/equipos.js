...
<MaterialReactTable
  ...
  renderRowActionMenuItems={({ row }) => [
    <MenuItem > <EditIcon sx={{ mr:1 }} /> <b>Eliminar</b> </MenuItem>,
    <MenuItem onClick={(event) => handleLinkAdd(event, "agregar", row)}> <EditIcon sx={{ mr:1 }} /> <b></b>Administrar Miembros </MenuItem>,
