...
import Alert from "@mui/material/Alert";
 ...
 setIdCliente(row.original.id_sector)
 setNombre(row.original.nombre_sector);
 ...
 if(row.original.estado ===0){
   ...
   handleEditar(row.original.id_sector,row.original.nombre_sector,row.original.descripcion,1);
 }else{
  
   handleEditar(row.original.id_sector,row.original.nombre_sector,row.original.descripcion,0);
 }
  ...
  <Box>
   ...
   <MaterialReactTable
        ...
        renderRowActionMenuItems={({ closeMenu, row }) => [
          <MenuItem > <EditIcon sx={{ mr:1 }} /> <b>Eliminar Sector</b> </MenuItem>,
          ...
          } > <EditIcon sx={{ mr:1 }} /> <b>Editar Sector</b> </MenuItem>
 ...
 {editar?"Editar Sector":"Crear Sector"}
          </Typography>
        </Box>
