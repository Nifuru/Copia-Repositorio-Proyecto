...
import Alert from "@mui/material/Alert";
 ...
 setIdCliente(row.original.id_industria)
 setNombre(row.original.nombre_industria);
 ...
 if(row.original.estado ===0){
   ...
   handleEditar(row.original.id_industria,row.original.nombre_industria,row.original.descripcion,1);
 }else{
  
   handleEditar(row.original.id_industria,row.original.nombre_industria,row.original.descripcion,0);
 }
  ...
  <Box>
   ...
   <MaterialReactTable
        ...
        renderRowActionMenuItems={({ closeMenu, row }) => [
          <MenuItem > <EditIcon sx={{ mr:1 }} /> <b>Eliminar Industria</b> </MenuItem>,
          ...
          } > <EditIcon sx={{ mr:1 }} /> <b>Editar Industria</b> </MenuItem>
 ...
 {editar?"Editar Industria":"Crear Industria"}
          </Typography>
        </Box>
